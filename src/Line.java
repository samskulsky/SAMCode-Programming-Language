...
public class Line {
	...
	public enum TokenType {
		RANDOM, WRITE, NUM, TEXT, BOOLEAN, LEFTP, RIGHTP, COMMA, ADD, SUBTRACT, MULTIPLY, DIVIDE, MOD, NOT, LESS,
		LESSOREQUAL, GREATER, GREATEROREQUAL, EQUAL, NOTEQUAL, AND, OR, IF, ELSE, CALC, INVALID, INPUT, ENDIF
	}
